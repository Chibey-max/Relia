...
const FAQS = [
  ['Does Relia move money between chains?', 'No. Payment settles on Sepolia and remains there. Creditcoin receives proof that the transactions happened, not bridged funds.'],
  ['What if the shop takes payment and stays silent?', 'The buyer can prove the payment alone after the window. The slice becomes Disputed and the shop cannot reclaim it.'],
  ...
  ['Can someone else pay for the buyer?', 'Yes. The receipt records both the buyer and the payer, so family or community payments are represented honestly.'],
];
    ...
    <main className="landing-main refreshed-landing">
      <Section spacing="none" tone="transparent" composition="open" className="landing-hero editorial-hero landing-section-narrative">
        ...
        <div className="hero-action-block" data-hero-reveal>
          <div className="hero-actions">
            <Button href="/send">Send an installment <span aria-hidden="true">→</span></Button>
            <Link className="text-action" href="/verify">Verify a public receipt <span aria-hidden="true">↗</span></Link>
          </div>
      ...
      <Section spacing="none" tone="transparent" composition="open" className="editorial-section problem-story landing-section-narrative" data-reveal data-reveal-group>
        ...
        <Grid columns={2} gap={12} className="story-grid" data-reveal-item>
          <div><h2>A payment history should belong to the person who earned it.</h2></div>
          <div>
            <p className="lead">
              In a shop notebook, the shop controls the record. If month five is marked missing, the buyer has no
              portable evidence—and eleven good payments do not follow them to the next shop.
            </p>
            <p className="body-copy">Relia gives both sides <DrawnUnderline className="story-drawn-underline">one public timeline</DrawnUnderline> backed by transactions rather than memory.</p>
          </div>
        </Grid>
        <div className="ledger-compare" data-scroll-story="ledger">
          <article className="ledger-sheet ledger-old">
            ...
            <div className="mini-row"><span>04</span><span>paid</span><span>✓</span></div>
            <div className="mini-row is-missing"><span>05</span><span>missed?</span><span>shop says</span></div>
            <div className="mini-row"><span>06</span><span>paid</span><span>✓</span></div>
            <p>Private, editable, and left behind.</p>
          </article>
          <div className="compare-arrow" aria-hidden="true"><span>becomes</span>→</div>
          <article className="ledger-sheet ledger-public">
            <div className="mini-title">THE PUBLIC TAPE</div>
            <div className="mini-row"><span>04</span><span className="state-live">✓ Live</span><span className="proof-hash">0x71c3…</span></div>
            <div className="mini-row"><span>05</span><span className="state-disputed">! Disputed</span><span className="proof-hash">0x2fb4…</span></div>
            <div className="mini-row"><span>06</span><span className="state-live">✓ Live</span><span className="proof-hash">0x9d0b…</span></div>
            <p>Public, permanent, and carried by URL.</p>
          </article>
        </div>
      </Section>
      ...
      <Section spacing="none" tone="transparent" composition="contained" className="process-section landing-section-data" data-reveal data-reveal-group aria-labelledby="process-title">
        <div className="section-heading-row" data-reveal-item>
          <div><div className="section-index">02 · PAYMENT TO TITLE</div><h2 id="process-title">Four legible steps. No money bridge.</h2></div>
          <div className="process-intro">
            <p className="lead">One installment gives the buyer and shop the same durable point of reference.</p>
      ...
      <Section spacing="none" tone="transparent" composition="evidence" className="receipt-stage landing-section-data" data-reveal data-reveal-group>
        <div className="receipt-copy" data-reveal-item>
          ...
          <h2>A receipt designed to be shared, checked, and understood.</h2>
          <p className="lead">See the result first. Payment references, block numbers, and the people involved sit directly beneath it.</p>
          ...
          <Button href="/verify">Open the receipt index <span aria-hidden="true">→</span></Button>
        </div>
        <LandingReceipt />
      </Section>
      ...
      <Section spacing="none" tone="transparent" composition="open" className="trust-section landing-section-narrative" data-reveal data-reveal-group>
        ...
        <Grid columns={2} gap={12} className="story-grid trust-heading" data-reveal-item>
          ...
          <p className="lead">Good outcomes are easy to display. A trustworthy tape must also explain silence, missed windows, and refused proofs.</p>
        </Grid>
        <div className="trust-cards">
          <Card as="article" variant="illustrated" className="trust-card trust-card-yellow" data-reveal-item="artifact">
            ...
            <h3>A shop cannot profit from staying silent.</h3>
            <p>If a payment is proven without a valid confirmation, reclaim is blocked and the payment record remains visible.</p>
          </Card>
          <Card as="article" variant="quiet" className="trust-card" data-reveal-item="artifact">
            <Badge tone="live">EXACT MATCH</Badge>
            <h3>A copied or altered record cannot sneak through.</h3>
            <p>Relia rebuilds the payment reference from the original record. Anything incomplete or unfamiliar is refused rather than guessed.</p>
          </Card>
        </div>
      </Section>
      ...
      <Section spacing="none" tone="transparent" composition="contained" className="architecture-section landing-section-data" data-reveal data-reveal-group aria-labelledby="architecture-title">
        <div className="section-heading-row" data-reveal-item>
          ...
          <p className="lead">Most people only need the receipt. The exact networks, record format, and verification path remain available for anyone who wants to audit it.</p>
        </div>
        <details className="technical-drawer" data-reveal-item="artifact">
          <summary>How verification works <span aria-hidden="true">+</span></summary>
      ...
      <Section spacing="none" tone="transparent" composition="open" className="status-section landing-section-data" data-reveal data-reveal-group>
        ...
        <div className="status-list" data-scroll-story="status">
          <div data-scroll-item>
            <span className={`status-symbol ${contractConfiguration.ready ? 'status-symbol-live' : 'status-symbol-warn'}`}>{contractConfiguration.ready ? '✓' : '!'}</span>
            <div>
          ...
          <div data-scroll-item><span className="status-symbol status-symbol-live">✓</span><div><strong>46 automated checks pass</strong><p>The contract suite covers successful updates and named refusal paths.</p></div><span className="status-badge status-live">46 PASS</span></div>
          <div data-scroll-item><span className="status-symbol status-symbol-warn">!</span><div><strong>Public networks can pause</strong><p>Reads and writes still depend on testnet RPC and proof services being available.</p></div><span className="status-badge status-disputed">TESTNET</span></div>
        </div>
      </Section>
          ...
          <div className="questions">
            {FAQS.map(([question, answer]) => (
              <details className="question" key={question}>
                <summary><span>{question}</span><span className="question-plus" aria-hidden="true">+</span></summary>
      ...
      <Section spacing="none" tone="proof" composition="evidence" className="final-cta landing-section-narrative" data-reveal data-reveal-group>
        ...
        <div data-reveal-item><div className="section-index section-index-light">START WITH THE PUBLIC RECORD</div><h2>Inspect first. Connect only when you are ready to write.</h2></div>
      ...
      <footer className="site-footer">
        <div className="footer-brand"><span className="brand-mark">R</span><div><strong>Relia</strong><p>Hire-purchase title, proven across chains.</p></div></div>
        <nav aria-label="Footer"><Link href="/tape">Tape</Link><Link href="/send">Send</Link><Link href="/title">Title</Link><Link href="/verify">Verify</Link></nav>
        <div className="footer-meta"><span>No bridged funds</span><span>Testnet only</span></div>
      </footer>
    </main>
  );
}
